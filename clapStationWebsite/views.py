...
def Tutor_view(request):
    ...
    context ={'tutorcon': tutorcon, 'user_info': user_info}    
...
def TutorContact(request, id):
    ...
    return render(request, 'tutorcontact.html', {'tutor': tutor, 'user_profile': user_profile})
...
def bandbooking(request, id):
    ...
    return render(request, 'bandbooking.html', {'bands': bands,'user_profile': user_profile})
...
def eventsdata(request, id):
    ...
    "event_adder":event_adder,"user_info":user_info})
...
def eventbooking(request, id):
    ...
    return render(request, 'eventbooking.html', {'events': event, 'user_profile': user_profile})
...
def artist_profile(request, pk):
    ...
    return render(
        ...
        "events":events,
        "profile_video_page":profile_video_page, "user_info":user_info}
    )
...
def contact_page(request):
    ...
    context = {'contact_info': contact_info, 'user_info': user_info}
